<?php if (is_category('yzjy')) { ?>
<script language="javascript">
    window.location = "http://web.fosu.edu.cn/cohe/?page_id=4090";
</script>
<?php }elseif(is_category('161')) { ?>
<script language="javascript">
    window.location = "http://web.fosu.edu.cn/jwc/?cat=29";
</script>
<?php }elseif(is_category('81')) { ?>
<script language="javascript">
    window.location = "http://web.fosu.edu.cn/cohe/?p=3494";
</script>
<?php }elseif(is_category('85')) { ?>
<script language="javascript">
    window.location = "http://web.fosu.edu.cn/cohe/?p=3496";
</script>
<?php }elseif(is_category('96')) { ?>
<script language="javascript">
    window.location = "http://web.fosu.edu.cn/cohe/?p=4754";
</script>
<?php }else { ?>
